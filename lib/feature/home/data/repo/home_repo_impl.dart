...
class HomeRepoImpl implements HomeRepo {
  ...
  @override
  Future<Result<UploadVideoEntity>> uploadVideo(String path, void Function(int sent, int total)? onProgress,) async {
  ...
  Future<Result<AnalysisEntity>> analysisAiVideo(
    ...
    final result = await _homeDataSource.analysisAiVideo(analysisRequest,onProgress);
    switch (result) {
